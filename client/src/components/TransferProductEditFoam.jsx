                      ...
                      >
                        <span className="  ">
                          <img
                            ...
                            src={`/public/transferImages/${pPhoto[0].path}`}
                            alt=""
                          />
                        </span>
                        {hoverShow1 && (
                    ...
                    {!pPhoto[1] && pPhoto.length > 0 ? (
                      ...
                      >
                        <span className="  ">
                          <img
                            className="addProductImageTag absolute "
                            src={`/public/transferImages/${pPhoto[1].path}`}
                            alt=""
                          />
                        </span>
                        {hoverShow2 && (
                    ...
                    {!pPhoto[2] && pPhoto.length > 0 ? (
                      ...
                      >
                        <span className="  ">
                          <img
                            className="addProductImageTag absolute "
                            src={`/public/transferImages/${pPhoto[2].path}`}
                            alt=""
                          />
                        </span>
                        {hoverShow3 && (
                    ...
                    {!pPhoto[3] && pPhoto.length > 0 ? (
                      ...
                      >
                        <span className="  ">
                          <img
                            className="addProductImageTag absolute "
                            src={`/public/transferImages/${pPhoto[3].path}`}
                            alt=""
                          />
                        </span>
                        {hoverShow4 && (
